...
def train_ann(hyperparameters, train_dataset, test_dataset, save_filename=None, load_filename=None, tblogs = "../tmp/tblogs", TF_DEVICE=''):
    ...
    test_accuracy = None
    loss_value = None
    record_file=open('903newtrain.txt','w')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--checkpoint_file', help='Name of the checkpoint file to save (without file extension)', required=False, default="train_903/current") #../models/training/current
    parser.add_argument('-r', '--train_dataset_filename', help='File name of the training dataset without extension', required=False, default="/home/bwang/dataset/lowsnr-trainset.npy")
    parser.add_argument('-e', '--test_dataset_filename', help='File name of the testing dataset without extension', required=False, default="/home/bwang/dataset/lowsnr-testset.npy")
